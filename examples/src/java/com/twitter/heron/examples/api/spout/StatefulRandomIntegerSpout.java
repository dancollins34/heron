...
public class StatefulRandomIntegerSpout extends BaseRichSpout
    implements IStatefulComponent<String, Long> {
  private static final Logger LOG = Logger.getLogger(StatefulRandomIntegerSpout.class.getName());
